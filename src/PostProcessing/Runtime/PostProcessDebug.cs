...
namespace UnityEngine.Rendering.PostProcessing
{
    ...
    public sealed class PostProcessDebug : MonoBehaviour
    {
        ...
        private const string _PRF_PFX = nameof(PostProcessDebug) + ".";
        private static readonly ProfilerMarker _PRF_UpdateStates = new ProfilerMarker(_PRF_PFX + nameof(UpdateStates));
        void UpdateStates()
        {
            using (_PRF_UpdateStates.Auto())
            {
