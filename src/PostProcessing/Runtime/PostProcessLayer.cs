...
//custom-end
        ...
        private static readonly ProfilerMarker _PRF_InitLegacy = new ProfilerMarker(_PRF_PFX + nameof(InitLegacy));
        
        void InitLegacy()
        {
            using (_PRF_InitLegacy.Auto())
            {
...
#if UNITY_2019_1_OR_NEWER
        private static readonly ProfilerMarker _PRF_OnRenderImage = new ProfilerMarker(_PRF_PFX + nameof(OnRenderImage));
        ...
        private static readonly ProfilerMarker _PRF_UpdateSrcDstForOpaqueOnly = new ProfilerMarker(_PRF_PFX + nameof(UpdateSrcDstForOpaqueOnly));
        ...
        {
            using (_PRF_UpdateSrcDstForOpaqueOnly.Auto())
            {
                if (src > -1)
        ...
        private static readonly ProfilerMarker _PRF_BuildCommandBuffers = new ProfilerMarker(_PRF_PFX + nameof(BuildCommandBuffers));
        void BuildCommandBuffers()
        {
            using (_PRF_BuildCommandBuffers.Auto())
            {
        ...
        private static readonly ProfilerMarker _PRF_OnPostRender = new ProfilerMarker(_PRF_PFX + nameof(OnPostRender));
        void OnPostRender()
        {
            using (_PRF_OnPostRender.Auto())
            {
                // Unused in scriptable render pipelines
                if (RuntimeUtilities.scriptableRenderPipelineActive)
                    return;
        ...
        private static readonly ProfilerMarker _PRF_BakeMSVOMap = new ProfilerMarker(_PRF_PFX + nameof(BakeMSVOMap));
		/// <summary>
        ...
        private static readonly ProfilerMarker _PRF_OverrideSettings = new ProfilerMarker(_PRF_PFX + nameof(OverrideSettings));
        internal void OverrideSettings(List<PostProcessEffectSettings> baseSettings, float interpFactor)
        {
            using (_PRF_OverrideSettings.Auto())
            {
        ...
        private static readonly ProfilerMarker _PRF_SetLegacyCameraFlags = new ProfilerMarker(_PRF_PFX + nameof(SetLegacyCameraFlags));
        ...
        {
            using (_PRF_SetLegacyCameraFlags.Auto())
            {
        ...
        private static readonly ProfilerMarker _PRF_ResetHistory = new ProfilerMarker(_PRF_PFX + nameof(ResetHistory));
        /// <summary>
        ...
        private static readonly ProfilerMarker _PRF_HasActiveEffects = new ProfilerMarker(_PRF_PFX + nameof(HasActiveEffects));
        /// <summary>
        ...
        {
            using (_PRF_HasActiveEffects.Auto())
            {
        ...
        private static readonly ProfilerMarker _PRF_SetupContext = new ProfilerMarker(_PRF_PFX + nameof(SetupContext));
        void SetupContext(PostProcessRenderContext context)
        {
            using (_PRF_SetupContext.Auto())
            {
...
//custom-end
        ...
        private static readonly ProfilerMarker _PRF_UpdateVolumeSystem = new ProfilerMarker(_PRF_PFX + nameof(UpdateVolumeSystem));
        /// <summary>
        ...
        {
            using (_PRF_UpdateVolumeSystem.Auto())
            {
        ...
        private static readonly ProfilerMarker _PRF_RenderOpaqueOnly = new ProfilerMarker(_PRF_PFX + nameof(RenderOpaqueOnly));
        /// <summary>
        ...
        {
            using (_PRF_RenderOpaqueOnly.Auto())
            {
                if (RuntimeUtilities.scriptableRenderPipelineActive)
                    SetupContext(context);
        ...
        private static readonly ProfilerMarker _PRF_Render = new ProfilerMarker(_PRF_PFX + nameof(Render));
        /// <summary>
        ...
        private static readonly ProfilerMarker _PRF_RenderInjectionPoint = new ProfilerMarker(_PRF_PFX + nameof(RenderInjectionPoint));
        int RenderInjectionPoint(PostProcessEvent evt, PostProcessRenderContext context, string marker, int releaseTargetAfterUse = -1)
        {
            using (_PRF_RenderInjectionPoint.Auto())
            {
        ...
        private static readonly ProfilerMarker _PRF_RenderList = new ProfilerMarker(_PRF_PFX + nameof(RenderList));
        void RenderList(List<SerializedBundleRef> list, PostProcessRenderContext context, string marker)
        {
            using (_PRF_RenderList.Auto())
            {
                var cmd = context.command;
        ...
        private static readonly ProfilerMarker _PRF_ApplyFlip = new ProfilerMarker(_PRF_PFX + nameof(ApplyFlip));
        void ApplyFlip(PostProcessRenderContext context, MaterialPropertyBlock properties)
        {
            using (_PRF_ApplyFlip.Auto())
            {
        ...
        private static readonly ProfilerMarker _PRF_RenderBuiltins = new ProfilerMarker(_PRF_PFX + nameof(RenderBuiltins));
        int RenderBuiltins(PostProcessRenderContext context, bool isFinalPass, int releaseTargetAfterUse = -1, int eye = -1)
        {
            using (_PRF_RenderBuiltins.Auto())
            {
        ...
        private static readonly ProfilerMarker _PRF_RenderFinalPass = new ProfilerMarker(_PRF_PFX + nameof(RenderFinalPass));
        ...
        {
            using (_PRF_RenderFinalPass.Auto())
            {
                var cmd = context.command;
        ...
        private static readonly ProfilerMarker _PRF_RenderEffect = new ProfilerMarker(_PRF_PFX + nameof(RenderEffect));
        int RenderEffect<T>(PostProcessRenderContext context, bool useTempTarget = false)
            where T : PostProcessEffectSettings
        {
            using (_PRF_RenderEffect.Auto())
            {
